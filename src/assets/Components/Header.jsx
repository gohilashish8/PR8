    ...
    <nav className="bg-white shadow-lg ">
        <div className="md:flex items-center justify-between py-2 px-8 md:px-12">
            ...
            <div className=" flex-col md:flex-row hidden md:flex -mx-2">
                ...
                <Link to={"/addnewdata"} className="text-gray-800 rounded hover:bg-gray-900 hover:text-gray-100 hover:font-medium py-2 px-2 md:mx-2">Add Data</Link>
                <Link to={"/viewdata"} className="text-gray-800 rounded hover:bg-gray-900 hover:text-gray-100 hover:font-medium py-2 px-2 md:mx-2">View Data</Link>
            </div>
        </div>
    </nav>
